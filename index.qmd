...
<!-- :::{.column-page} -->
{{< embed resources/ouilove_plot.ipynb#fig-love-oui-love >}}
<!-- ::: -->
...
In this work we suggest three candidate channels [@resources/ouilove_plot.ipynb#fig-fig-oui-encoding], which can be combined arbitrarily:
...
<!-- :::{.column-page} -->
{{< embed resources/ouilove_plot.ipynb#fig-oui-encoding >}}
<!-- ::: -->
...
{{< embed resources/dag-1.qmd#fig-dag1 >}}
